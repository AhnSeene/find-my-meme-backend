...
import com.findmymeme.common.queryconfig.QueryCountInspector.Counter;
...
public class LoggingInterceptor implements HandlerInterceptor {
    ...
    private static final String QUERY_COUNT_LOG_FORMAT = "STATUS_CODE: {}, METHOD: {}, URL: {}, TIME: {}ms, QUERY_COUNT: {}";
    ...
    public void afterCompletion(final HttpServletRequest request, final HttpServletResponse response,
        ...
        final double duration = (System.currentTimeMillis() - counter.getTime());
